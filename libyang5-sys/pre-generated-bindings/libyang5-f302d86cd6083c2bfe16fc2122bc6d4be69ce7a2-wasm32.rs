...
#[derive(Debug, Default, Copy, Clone)]
pub struct in6_addr {
    pub s6_addr: [::std::os::raw::c_uchar; 16usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of in6_addr"][::std::mem::size_of::<in6_addr>() - 16usize];
    ["Alignment of in6_addr"][::std::mem::align_of::<in6_addr>() - 4usize];
    ["Offset of field: in6_addr::s6_addr"]
        [::std::mem::offset_of!(in6_addr, s6_addr) - 0usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ly_err_item"][::std::mem::size_of::<ly_err_item>() - 48usize];
    ...
    ["Offset of field: ly_err_item::msg"]
        [::std::mem::offset_of!(ly_err_item, msg) - 12usize];
    ["Offset of field: ly_err_item::data_path"]
        [::std::mem::offset_of!(ly_err_item, data_path) - 16usize];
    ["Offset of field: ly_err_item::schema_path"]
        [::std::mem::offset_of!(ly_err_item, schema_path) - 20usize];
    ["Offset of field: ly_err_item::line"]
        [::std::mem::offset_of!(ly_err_item, line) - 24usize];
    ["Offset of field: ly_err_item::apptag"]
        [::std::mem::offset_of!(ly_err_item, apptag) - 32usize];
    ["Offset of field: ly_err_item::next"]
        [::std::mem::offset_of!(ly_err_item, next) - 36usize];
    ["Offset of field: ly_err_item::prev"]
        [::std::mem::offset_of!(ly_err_item, prev) - 40usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysp_import"][::std::mem::size_of::<lysp_import>() - 40usize];
    ["Alignment of lysp_import"]
        [::std::mem::align_of::<lysp_import>() - 4usize];
    ["Offset of field: lysp_import::module"]
        [::std::mem::offset_of!(lysp_import, module) - 0usize];
    ["Offset of field: lysp_import::name"]
        [::std::mem::offset_of!(lysp_import, name) - 4usize];
    ["Offset of field: lysp_import::prefix"]
        [::std::mem::offset_of!(lysp_import, prefix) - 8usize];
    ["Offset of field: lysp_import::dsc"]
        [::std::mem::offset_of!(lysp_import, dsc) - 12usize];
    ["Offset of field: lysp_import::ref_"]
        [::std::mem::offset_of!(lysp_import, ref_) - 16usize];
    ["Offset of field: lysp_import::exts"]
        [::std::mem::offset_of!(lysp_import, exts) - 20usize];
    ["Offset of field: lysp_import::flags"]
        [::std::mem::offset_of!(lysp_import, flags) - 24usize];
    ["Offset of field: lysp_import::rev"]
        [::std::mem::offset_of!(lysp_import, rev) - 26usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysp_include"][::std::mem::size_of::<lysp_include>() - 32usize];
    ["Alignment of lysp_include"]
        [::std::mem::align_of::<lysp_include>() - 4usize];
    ["Offset of field: lysp_include::submodule"]
        [::std::mem::offset_of!(lysp_include, submodule) - 0usize];
    ["Offset of field: lysp_include::name"]
        [::std::mem::offset_of!(lysp_include, name) - 4usize];
    ["Offset of field: lysp_include::dsc"]
        [::std::mem::offset_of!(lysp_include, dsc) - 8usize];
    ["Offset of field: lysp_include::ref_"]
        [::std::mem::offset_of!(lysp_include, ref_) - 12usize];
    ["Offset of field: lysp_include::exts"]
        [::std::mem::offset_of!(lysp_include, exts) - 16usize];
    ["Offset of field: lysp_include::rev"]
        [::std::mem::offset_of!(lysp_include, rev) - 20usize];
    ["Offset of field: lysp_include::injected"]
        [::std::mem::offset_of!(lysp_include, injected) - 31usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysp_ext"][::std::mem::size_of::<lysp_ext>() - 28usize];
    ["Alignment of lysp_ext"][::std::mem::align_of::<lysp_ext>() - 4usize];
    ["Offset of field: lysp_ext::name"]
        [::std::mem::offset_of!(lysp_ext, name) - 0usize];
    ["Offset of field: lysp_ext::argname"]
        [::std::mem::offset_of!(lysp_ext, argname) - 4usize];
    ["Offset of field: lysp_ext::dsc"]
        [::std::mem::offset_of!(lysp_ext, dsc) - 8usize];
    ["Offset of field: lysp_ext::ref_"]
        [::std::mem::offset_of!(lysp_ext, ref_) - 12usize];
    ["Offset of field: lysp_ext::exts"]
        [::std::mem::offset_of!(lysp_ext, exts) - 16usize];
    ["Offset of field: lysp_ext::plugin_ref"]
        [::std::mem::offset_of!(lysp_ext, plugin_ref) - 20usize];
    ["Offset of field: lysp_ext::flags"]
        [::std::mem::offset_of!(lysp_ext, flags) - 24usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysp_feature"][::std::mem::size_of::<lysp_feature>() - 32usize];
    ["Alignment of lysp_feature"]
        [::std::mem::align_of::<lysp_feature>() - 4usize];
    ["Offset of field: lysp_feature::name"]
        [::std::mem::offset_of!(lysp_feature, name) - 0usize];
    ["Offset of field: lysp_feature::iffeatures"]
        [::std::mem::offset_of!(lysp_feature, iffeatures) - 4usize];
    ["Offset of field: lysp_feature::iffeatures_c"]
        [::std::mem::offset_of!(lysp_feature, iffeatures_c) - 8usize];
    ["Offset of field: lysp_feature::depfeatures"]
        [::std::mem::offset_of!(lysp_feature, depfeatures) - 12usize];
    ["Offset of field: lysp_feature::dsc"]
        [::std::mem::offset_of!(lysp_feature, dsc) - 16usize];
    ["Offset of field: lysp_feature::ref_"]
        [::std::mem::offset_of!(lysp_feature, ref_) - 20usize];
    ["Offset of field: lysp_feature::exts"]
        [::std::mem::offset_of!(lysp_feature, exts) - 24usize];
    ["Offset of field: lysp_feature::flags"]
        [::std::mem::offset_of!(lysp_feature, flags) - 28usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysp_qname"][::std::mem::size_of::<lysp_qname>() - 12usize];
    ["Alignment of lysp_qname"][::std::mem::align_of::<lysp_qname>() - 4usize];
    ["Offset of field: lysp_qname::str_"]
        [::std::mem::offset_of!(lysp_qname, str_) - 0usize];
    ["Offset of field: lysp_qname::mod_"]
        [::std::mem::offset_of!(lysp_qname, mod_) - 4usize];
    ["Offset of field: lysp_qname::flags"]
        [::std::mem::offset_of!(lysp_qname, flags) - 8usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysp_ident"][::std::mem::size_of::<lysp_ident>() - 28usize];
    ["Alignment of lysp_ident"][::std::mem::align_of::<lysp_ident>() - 4usize];
    ["Offset of field: lysp_ident::name"]
        [::std::mem::offset_of!(lysp_ident, name) - 0usize];
    ["Offset of field: lysp_ident::iffeatures"]
        [::std::mem::offset_of!(lysp_ident, iffeatures) - 4usize];
    ["Offset of field: lysp_ident::bases"]
        [::std::mem::offset_of!(lysp_ident, bases) - 8usize];
    ["Offset of field: lysp_ident::dsc"]
        [::std::mem::offset_of!(lysp_ident, dsc) - 12usize];
    ["Offset of field: lysp_ident::ref_"]
        [::std::mem::offset_of!(lysp_ident, ref_) - 16usize];
    ["Offset of field: lysp_ident::exts"]
        [::std::mem::offset_of!(lysp_ident, exts) - 20usize];
    ["Offset of field: lysp_ident::flags"]
        [::std::mem::offset_of!(lysp_ident, flags) - 24usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysp_restr"][::std::mem::size_of::<lysp_restr>() - 32usize];
    ["Alignment of lysp_restr"][::std::mem::align_of::<lysp_restr>() - 4usize];
    ["Offset of field: lysp_restr::arg"]
        [::std::mem::offset_of!(lysp_restr, arg) - 0usize];
    ["Offset of field: lysp_restr::emsg"]
        [::std::mem::offset_of!(lysp_restr, emsg) - 12usize];
    ["Offset of field: lysp_restr::eapptag"]
        [::std::mem::offset_of!(lysp_restr, eapptag) - 16usize];
    ["Offset of field: lysp_restr::dsc"]
        [::std::mem::offset_of!(lysp_restr, dsc) - 20usize];
    ["Offset of field: lysp_restr::ref_"]
        [::std::mem::offset_of!(lysp_restr, ref_) - 24usize];
    ["Offset of field: lysp_restr::exts"]
        [::std::mem::offset_of!(lysp_restr, exts) - 28usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysp_revision"][::std::mem::size_of::<lysp_revision>() - 24usize];
    ["Alignment of lysp_revision"]
        [::std::mem::align_of::<lysp_revision>() - 4usize];
    ["Offset of field: lysp_revision::date"]
        [::std::mem::offset_of!(lysp_revision, date) - 0usize];
    ["Offset of field: lysp_revision::dsc"]
        [::std::mem::offset_of!(lysp_revision, dsc) - 12usize];
    ["Offset of field: lysp_revision::ref_"]
        [::std::mem::offset_of!(lysp_revision, ref_) - 16usize];
    ["Offset of field: lysp_revision::exts"]
        [::std::mem::offset_of!(lysp_revision, exts) - 20usize];
};
...
const _: () = {
    ["Size of lysp_type_enum"]
        [::std::mem::size_of::<lysp_type_enum>() - 40usize];
    ...
    ["Offset of field: lysp_type_enum::dsc"]
        [::std::mem::offset_of!(lysp_type_enum, dsc) - 4usize];
    ["Offset of field: lysp_type_enum::ref_"]
        [::std::mem::offset_of!(lysp_type_enum, ref_) - 8usize];
    ["Offset of field: lysp_type_enum::value"]
        [::std::mem::offset_of!(lysp_type_enum, value) - 16usize];
    ["Offset of field: lysp_type_enum::iffeatures"]
        [::std::mem::offset_of!(lysp_type_enum, iffeatures) - 24usize];
    ["Offset of field: lysp_type_enum::exts"]
        [::std::mem::offset_of!(lysp_type_enum, exts) - 28usize];
    ["Offset of field: lysp_type_enum::flags"]
        [::std::mem::offset_of!(lysp_type_enum, flags) - 32usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysp_type"][::std::mem::size_of::<lysp_type>() - 52usize];
    ["Alignment of lysp_type"][::std::mem::align_of::<lysp_type>() - 4usize];
    ["Offset of field: lysp_type::name"]
        [::std::mem::offset_of!(lysp_type, name) - 0usize];
    ["Offset of field: lysp_type::range"]
        [::std::mem::offset_of!(lysp_type, range) - 4usize];
    ["Offset of field: lysp_type::length"]
        [::std::mem::offset_of!(lysp_type, length) - 8usize];
    ["Offset of field: lysp_type::patterns"]
        [::std::mem::offset_of!(lysp_type, patterns) - 12usize];
    ["Offset of field: lysp_type::enums"]
        [::std::mem::offset_of!(lysp_type, enums) - 16usize];
    ["Offset of field: lysp_type::bits"]
        [::std::mem::offset_of!(lysp_type, bits) - 20usize];
    ["Offset of field: lysp_type::path"]
        [::std::mem::offset_of!(lysp_type, path) - 24usize];
    ["Offset of field: lysp_type::bases"]
        [::std::mem::offset_of!(lysp_type, bases) - 28usize];
    ["Offset of field: lysp_type::types"]
        [::std::mem::offset_of!(lysp_type, types) - 32usize];
    ["Offset of field: lysp_type::exts"]
        [::std::mem::offset_of!(lysp_type, exts) - 36usize];
    ["Offset of field: lysp_type::pmod"]
        [::std::mem::offset_of!(lysp_type, pmod) - 40usize];
    ["Offset of field: lysp_type::compiled"]
        [::std::mem::offset_of!(lysp_type, compiled) - 44usize];
    ["Offset of field: lysp_type::fraction_digits"]
        [::std::mem::offset_of!(lysp_type, fraction_digits) - 48usize];
    ["Offset of field: lysp_type::require_instance"]
        [::std::mem::offset_of!(lysp_type, require_instance) - 49usize];
    ["Offset of field: lysp_type::flags"]
        [::std::mem::offset_of!(lysp_type, flags) - 50usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysp_tpdf"][::std::mem::size_of::<lysp_tpdf>() - 88usize];
    ["Alignment of lysp_tpdf"][::std::mem::align_of::<lysp_tpdf>() - 4usize];
    ["Offset of field: lysp_tpdf::name"]
        [::std::mem::offset_of!(lysp_tpdf, name) - 0usize];
    ["Offset of field: lysp_tpdf::units"]
        [::std::mem::offset_of!(lysp_tpdf, units) - 4usize];
    ["Offset of field: lysp_tpdf::dflt"]
        [::std::mem::offset_of!(lysp_tpdf, dflt) - 8usize];
    ["Offset of field: lysp_tpdf::dsc"]
        [::std::mem::offset_of!(lysp_tpdf, dsc) - 20usize];
    ["Offset of field: lysp_tpdf::ref_"]
        [::std::mem::offset_of!(lysp_tpdf, ref_) - 24usize];
    ["Offset of field: lysp_tpdf::exts"]
        [::std::mem::offset_of!(lysp_tpdf, exts) - 28usize];
    ["Offset of field: lysp_tpdf::type_"]
        [::std::mem::offset_of!(lysp_tpdf, type_) - 32usize];
    ["Offset of field: lysp_tpdf::flags"]
        [::std::mem::offset_of!(lysp_tpdf, flags) - 84usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysp_when"][::std::mem::size_of::<lysp_when>() - 16usize];
    ["Alignment of lysp_when"][::std::mem::align_of::<lysp_when>() - 4usize];
    ["Offset of field: lysp_when::cond"]
        [::std::mem::offset_of!(lysp_when, cond) - 0usize];
    ["Offset of field: lysp_when::dsc"]
        [::std::mem::offset_of!(lysp_when, dsc) - 4usize];
    ["Offset of field: lysp_when::ref_"]
        [::std::mem::offset_of!(lysp_when, ref_) - 8usize];
    ["Offset of field: lysp_when::exts"]
        [::std::mem::offset_of!(lysp_when, exts) - 12usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysp_refine"][::std::mem::size_of::<lysp_refine>() - 44usize];
    ["Alignment of lysp_refine"]
        [::std::mem::align_of::<lysp_refine>() - 4usize];
    ["Offset of field: lysp_refine::nodeid"]
        [::std::mem::offset_of!(lysp_refine, nodeid) - 0usize];
    ["Offset of field: lysp_refine::dsc"]
        [::std::mem::offset_of!(lysp_refine, dsc) - 4usize];
    ["Offset of field: lysp_refine::ref_"]
        [::std::mem::offset_of!(lysp_refine, ref_) - 8usize];
    ["Offset of field: lysp_refine::iffeatures"]
        [::std::mem::offset_of!(lysp_refine, iffeatures) - 12usize];
    ["Offset of field: lysp_refine::musts"]
        [::std::mem::offset_of!(lysp_refine, musts) - 16usize];
    ["Offset of field: lysp_refine::presence"]
        [::std::mem::offset_of!(lysp_refine, presence) - 20usize];
    ["Offset of field: lysp_refine::dflts"]
        [::std::mem::offset_of!(lysp_refine, dflts) - 24usize];
    ["Offset of field: lysp_refine::min"]
        [::std::mem::offset_of!(lysp_refine, min) - 28usize];
    ["Offset of field: lysp_refine::max"]
        [::std::mem::offset_of!(lysp_refine, max) - 32usize];
    ["Offset of field: lysp_refine::exts"]
        [::std::mem::offset_of!(lysp_refine, exts) - 36usize];
    ["Offset of field: lysp_refine::flags"]
        [::std::mem::offset_of!(lysp_refine, flags) - 40usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysp_deviate"][::std::mem::size_of::<lysp_deviate>() - 12usize];
    ["Alignment of lysp_deviate"]
        [::std::mem::align_of::<lysp_deviate>() - 4usize];
    ["Offset of field: lysp_deviate::mod_"]
        [::std::mem::offset_of!(lysp_deviate, mod_) - 0usize];
    ["Offset of field: lysp_deviate::next"]
        [::std::mem::offset_of!(lysp_deviate, next) - 4usize];
    ["Offset of field: lysp_deviate::exts"]
        [::std::mem::offset_of!(lysp_deviate, exts) - 8usize];
};
...
const _: () = {
    ["Size of lysp_deviate_add"]
        [::std::mem::size_of::<lysp_deviate_add>() - 40usize];
    ["Alignment of lysp_deviate_add"]
        [::std::mem::align_of::<lysp_deviate_add>() - 4usize];
    ["Offset of field: lysp_deviate_add::mod_"]
        [::std::mem::offset_of!(lysp_deviate_add, mod_) - 0usize];
    ["Offset of field: lysp_deviate_add::next"]
        [::std::mem::offset_of!(lysp_deviate_add, next) - 4usize];
    ["Offset of field: lysp_deviate_add::exts"]
        [::std::mem::offset_of!(lysp_deviate_add, exts) - 8usize];
    ["Offset of field: lysp_deviate_add::units"]
        [::std::mem::offset_of!(lysp_deviate_add, units) - 12usize];
    ["Offset of field: lysp_deviate_add::musts"]
        [::std::mem::offset_of!(lysp_deviate_add, musts) - 16usize];
    ["Offset of field: lysp_deviate_add::uniques"]
        [::std::mem::offset_of!(lysp_deviate_add, uniques) - 20usize];
    ["Offset of field: lysp_deviate_add::dflts"]
        [::std::mem::offset_of!(lysp_deviate_add, dflts) - 24usize];
    ["Offset of field: lysp_deviate_add::flags"]
        [::std::mem::offset_of!(lysp_deviate_add, flags) - 28usize];
    ["Offset of field: lysp_deviate_add::min"]
        [::std::mem::offset_of!(lysp_deviate_add, min) - 32usize];
    ["Offset of field: lysp_deviate_add::max"]
        [::std::mem::offset_of!(lysp_deviate_add, max) - 36usize];
};
...
const _: () = {
    ["Size of lysp_deviate_del"]
        [::std::mem::size_of::<lysp_deviate_del>() - 28usize];
    ["Alignment of lysp_deviate_del"]
        [::std::mem::align_of::<lysp_deviate_del>() - 4usize];
    ["Offset of field: lysp_deviate_del::mod_"]
        [::std::mem::offset_of!(lysp_deviate_del, mod_) - 0usize];
    ["Offset of field: lysp_deviate_del::next"]
        [::std::mem::offset_of!(lysp_deviate_del, next) - 4usize];
    ["Offset of field: lysp_deviate_del::exts"]
        [::std::mem::offset_of!(lysp_deviate_del, exts) - 8usize];
    ["Offset of field: lysp_deviate_del::units"]
        [::std::mem::offset_of!(lysp_deviate_del, units) - 12usize];
    ["Offset of field: lysp_deviate_del::musts"]
        [::std::mem::offset_of!(lysp_deviate_del, musts) - 16usize];
    ["Offset of field: lysp_deviate_del::uniques"]
        [::std::mem::offset_of!(lysp_deviate_del, uniques) - 20usize];
    ["Offset of field: lysp_deviate_del::dflts"]
        [::std::mem::offset_of!(lysp_deviate_del, dflts) - 24usize];
};
...
const _: () = {
    ["Size of lysp_deviate_rpl"]
        [::std::mem::size_of::<lysp_deviate_rpl>() - 44usize];
    ["Alignment of lysp_deviate_rpl"]
        [::std::mem::align_of::<lysp_deviate_rpl>() - 4usize];
    ["Offset of field: lysp_deviate_rpl::mod_"]
        [::std::mem::offset_of!(lysp_deviate_rpl, mod_) - 0usize];
    ["Offset of field: lysp_deviate_rpl::next"]
        [::std::mem::offset_of!(lysp_deviate_rpl, next) - 4usize];
    ["Offset of field: lysp_deviate_rpl::exts"]
        [::std::mem::offset_of!(lysp_deviate_rpl, exts) - 8usize];
    ["Offset of field: lysp_deviate_rpl::type_"]
        [::std::mem::offset_of!(lysp_deviate_rpl, type_) - 12usize];
    ["Offset of field: lysp_deviate_rpl::units"]
        [::std::mem::offset_of!(lysp_deviate_rpl, units) - 16usize];
    ["Offset of field: lysp_deviate_rpl::dflt"]
        [::std::mem::offset_of!(lysp_deviate_rpl, dflt) - 20usize];
    ["Offset of field: lysp_deviate_rpl::flags"]
        [::std::mem::offset_of!(lysp_deviate_rpl, flags) - 32usize];
    ["Offset of field: lysp_deviate_rpl::min"]
        [::std::mem::offset_of!(lysp_deviate_rpl, min) - 36usize];
    ["Offset of field: lysp_deviate_rpl::max"]
        [::std::mem::offset_of!(lysp_deviate_rpl, max) - 40usize];
};
...
const _: () = {
    ["Size of lysp_deviation"]
        [::std::mem::size_of::<lysp_deviation>() - 20usize];
    ["Alignment of lysp_deviation"]
        [::std::mem::align_of::<lysp_deviation>() - 4usize];
    ["Offset of field: lysp_deviation::nodeid"]
        [::std::mem::offset_of!(lysp_deviation, nodeid) - 0usize];
    ["Offset of field: lysp_deviation::dsc"]
        [::std::mem::offset_of!(lysp_deviation, dsc) - 4usize];
    ["Offset of field: lysp_deviation::ref_"]
        [::std::mem::offset_of!(lysp_deviation, ref_) - 8usize];
    ["Offset of field: lysp_deviation::deviates"]
        [::std::mem::offset_of!(lysp_deviation, deviates) - 12usize];
    ["Offset of field: lysp_deviation::exts"]
        [::std::mem::offset_of!(lysp_deviation, exts) - 16usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysp_node"][::std::mem::size_of::<lysp_node>() - 32usize];
    ["Alignment of lysp_node"][::std::mem::align_of::<lysp_node>() - 4usize];
    ["Offset of field: lysp_node::parent"]
        [::std::mem::offset_of!(lysp_node, parent) - 0usize];
    ["Offset of field: lysp_node::nodetype"]
        [::std::mem::offset_of!(lysp_node, nodetype) - 4usize];
    ["Offset of field: lysp_node::flags"]
        [::std::mem::offset_of!(lysp_node, flags) - 6usize];
    ["Offset of field: lysp_node::next"]
        [::std::mem::offset_of!(lysp_node, next) - 8usize];
    ["Offset of field: lysp_node::name"]
        [::std::mem::offset_of!(lysp_node, name) - 12usize];
    ["Offset of field: lysp_node::dsc"]
        [::std::mem::offset_of!(lysp_node, dsc) - 16usize];
    ["Offset of field: lysp_node::ref_"]
        [::std::mem::offset_of!(lysp_node, ref_) - 20usize];
    ["Offset of field: lysp_node::iffeatures"]
        [::std::mem::offset_of!(lysp_node, iffeatures) - 24usize];
    ["Offset of field: lysp_node::exts"]
        [::std::mem::offset_of!(lysp_node, exts) - 28usize];
};
...
const _: () = {
    ["Size of lysp_node_container__bindgen_ty_1"]
        [::std::mem::size_of::<lysp_node_container__bindgen_ty_1>() - 32usize];
    ["Alignment of lysp_node_container__bindgen_ty_1"]
        [::std::mem::align_of::<lysp_node_container__bindgen_ty_1>() - 4usize];
...
const _: () = {
    ["Size of lysp_node_container"]
        [::std::mem::size_of::<lysp_node_container>() - 64usize];
    ["Alignment of lysp_node_container"]
        [::std::mem::align_of::<lysp_node_container>() - 4usize];
    ["Offset of field: lysp_node_container::musts"]
        [::std::mem::offset_of!(lysp_node_container, musts) - 32usize];
    ["Offset of field: lysp_node_container::when"]
        [::std::mem::offset_of!(lysp_node_container, when) - 36usize];
    ["Offset of field: lysp_node_container::presence"]
        [::std::mem::offset_of!(lysp_node_container, presence) - 40usize];
    ["Offset of field: lysp_node_container::typedefs"]
        [::std::mem::offset_of!(lysp_node_container, typedefs) - 44usize];
    ["Offset of field: lysp_node_container::groupings"]
        [::std::mem::offset_of!(lysp_node_container, groupings) - 48usize];
    ["Offset of field: lysp_node_container::child"]
        [::std::mem::offset_of!(lysp_node_container, child) - 52usize];
    ["Offset of field: lysp_node_container::actions"]
        [::std::mem::offset_of!(lysp_node_container, actions) - 56usize];
    ["Offset of field: lysp_node_container::notifs"]
        [::std::mem::offset_of!(lysp_node_container, notifs) - 60usize];
};
...
const _: () = {
    ["Size of lysp_node_leaf__bindgen_ty_1"]
        [::std::mem::size_of::<lysp_node_leaf__bindgen_ty_1>() - 32usize];
    ["Alignment of lysp_node_leaf__bindgen_ty_1"]
        [::std::mem::align_of::<lysp_node_leaf__bindgen_ty_1>() - 4usize];
...
const _: () = {
    ["Size of lysp_node_leaf"]
        [::std::mem::size_of::<lysp_node_leaf>() - 108usize];
    ["Alignment of lysp_node_leaf"]
        [::std::mem::align_of::<lysp_node_leaf>() - 4usize];
    ["Offset of field: lysp_node_leaf::musts"]
        [::std::mem::offset_of!(lysp_node_leaf, musts) - 32usize];
    ["Offset of field: lysp_node_leaf::when"]
        [::std::mem::offset_of!(lysp_node_leaf, when) - 36usize];
    ["Offset of field: lysp_node_leaf::type_"]
        [::std::mem::offset_of!(lysp_node_leaf, type_) - 40usize];
    ["Offset of field: lysp_node_leaf::units"]
        [::std::mem::offset_of!(lysp_node_leaf, units) - 92usize];
    ["Offset of field: lysp_node_leaf::dflt"]
        [::std::mem::offset_of!(lysp_node_leaf, dflt) - 96usize];
};
...
const _: () = {
    ["Size of lysp_node_leaflist__bindgen_ty_1"]
        [::std::mem::size_of::<lysp_node_leaflist__bindgen_ty_1>() - 32usize];
    ["Alignment of lysp_node_leaflist__bindgen_ty_1"]
        [::std::mem::align_of::<lysp_node_leaflist__bindgen_ty_1>() - 4usize];
...
const _: () = {
    ["Size of lysp_node_leaflist"]
        [::std::mem::size_of::<lysp_node_leaflist>() - 108usize];
    ["Alignment of lysp_node_leaflist"]
        [::std::mem::align_of::<lysp_node_leaflist>() - 4usize];
    ["Offset of field: lysp_node_leaflist::musts"]
        [::std::mem::offset_of!(lysp_node_leaflist, musts) - 32usize];
    ["Offset of field: lysp_node_leaflist::when"]
        [::std::mem::offset_of!(lysp_node_leaflist, when) - 36usize];
    ["Offset of field: lysp_node_leaflist::type_"]
        [::std::mem::offset_of!(lysp_node_leaflist, type_) - 40usize];
    ["Offset of field: lysp_node_leaflist::units"]
        [::std::mem::offset_of!(lysp_node_leaflist, units) - 92usize];
    ["Offset of field: lysp_node_leaflist::dflts"]
        [::std::mem::offset_of!(lysp_node_leaflist, dflts) - 96usize];
    ["Offset of field: lysp_node_leaflist::min"]
        [::std::mem::offset_of!(lysp_node_leaflist, min) - 100usize];
    ["Offset of field: lysp_node_leaflist::max"]
        [::std::mem::offset_of!(lysp_node_leaflist, max) - 104usize];
};
...
const _: () = {
    ["Size of lysp_node_list__bindgen_ty_1"]
        [::std::mem::size_of::<lysp_node_list__bindgen_ty_1>() - 32usize];
    ["Alignment of lysp_node_list__bindgen_ty_1"]
        [::std::mem::align_of::<lysp_node_list__bindgen_ty_1>() - 4usize];
...
const _: () = {
    ["Size of lysp_node_list"]
        [::std::mem::size_of::<lysp_node_list>() - 76usize];
    ["Alignment of lysp_node_list"]
        [::std::mem::align_of::<lysp_node_list>() - 4usize];
    ["Offset of field: lysp_node_list::musts"]
        [::std::mem::offset_of!(lysp_node_list, musts) - 32usize];
    ["Offset of field: lysp_node_list::when"]
        [::std::mem::offset_of!(lysp_node_list, when) - 36usize];
    ["Offset of field: lysp_node_list::key"]
        [::std::mem::offset_of!(lysp_node_list, key) - 40usize];
    ["Offset of field: lysp_node_list::typedefs"]
        [::std::mem::offset_of!(lysp_node_list, typedefs) - 44usize];
    ["Offset of field: lysp_node_list::groupings"]
        [::std::mem::offset_of!(lysp_node_list, groupings) - 48usize];
    ["Offset of field: lysp_node_list::child"]
        [::std::mem::offset_of!(lysp_node_list, child) - 52usize];
    ["Offset of field: lysp_node_list::actions"]
        [::std::mem::offset_of!(lysp_node_list, actions) - 56usize];
    ["Offset of field: lysp_node_list::notifs"]
        [::std::mem::offset_of!(lysp_node_list, notifs) - 60usize];
    ["Offset of field: lysp_node_list::uniques"]
        [::std::mem::offset_of!(lysp_node_list, uniques) - 64usize];
    ["Offset of field: lysp_node_list::min"]
        [::std::mem::offset_of!(lysp_node_list, min) - 68usize];
    ["Offset of field: lysp_node_list::max"]
        [::std::mem::offset_of!(lysp_node_list, max) - 72usize];
};
...
const _: () = {
    ["Size of lysp_node_choice__bindgen_ty_1"]
        [::std::mem::size_of::<lysp_node_choice__bindgen_ty_1>() - 32usize];
    ["Alignment of lysp_node_choice__bindgen_ty_1"]
        [::std::mem::align_of::<lysp_node_choice__bindgen_ty_1>() - 4usize];
...
const _: () = {
    ["Size of lysp_node_choice"]
        [::std::mem::size_of::<lysp_node_choice>() - 52usize];
    ["Alignment of lysp_node_choice"]
        [::std::mem::align_of::<lysp_node_choice>() - 4usize];
    ["Offset of field: lysp_node_choice::child"]
        [::std::mem::offset_of!(lysp_node_choice, child) - 32usize];
    ["Offset of field: lysp_node_choice::when"]
        [::std::mem::offset_of!(lysp_node_choice, when) - 36usize];
    ["Offset of field: lysp_node_choice::dflt"]
        [::std::mem::offset_of!(lysp_node_choice, dflt) - 40usize];
};
...
const _: () = {
    ["Size of lysp_node_case__bindgen_ty_1"]
        [::std::mem::size_of::<lysp_node_case__bindgen_ty_1>() - 32usize];
    ["Alignment of lysp_node_case__bindgen_ty_1"]
        [::std::mem::align_of::<lysp_node_case__bindgen_ty_1>() - 4usize];
...
const _: () = {
    ["Size of lysp_node_case"]
        [::std::mem::size_of::<lysp_node_case>() - 40usize];
    ["Alignment of lysp_node_case"]
        [::std::mem::align_of::<lysp_node_case>() - 4usize];
    ["Offset of field: lysp_node_case::child"]
        [::std::mem::offset_of!(lysp_node_case, child) - 32usize];
    ["Offset of field: lysp_node_case::when"]
        [::std::mem::offset_of!(lysp_node_case, when) - 36usize];
};
...
const _: () = {
    ["Size of lysp_node_anydata__bindgen_ty_1"]
        [::std::mem::size_of::<lysp_node_anydata__bindgen_ty_1>() - 32usize];
    ["Alignment of lysp_node_anydata__bindgen_ty_1"]
        [::std::mem::align_of::<lysp_node_anydata__bindgen_ty_1>() - 4usize];
...
const _: () = {
    ["Size of lysp_node_anydata"]
        [::std::mem::size_of::<lysp_node_anydata>() - 40usize];
    ["Alignment of lysp_node_anydata"]
        [::std::mem::align_of::<lysp_node_anydata>() - 4usize];
    ["Offset of field: lysp_node_anydata::musts"]
        [::std::mem::offset_of!(lysp_node_anydata, musts) - 32usize];
    ["Offset of field: lysp_node_anydata::when"]
        [::std::mem::offset_of!(lysp_node_anydata, when) - 36usize];
};
...
const _: () = {
    ["Size of lysp_node_uses__bindgen_ty_1"]
        [::std::mem::size_of::<lysp_node_uses__bindgen_ty_1>() - 32usize];
    ["Alignment of lysp_node_uses__bindgen_ty_1"]
        [::std::mem::align_of::<lysp_node_uses__bindgen_ty_1>() - 4usize];
...
const _: () = {
    ["Size of lysp_node_uses"]
        [::std::mem::size_of::<lysp_node_uses>() - 44usize];
    ["Alignment of lysp_node_uses"]
        [::std::mem::align_of::<lysp_node_uses>() - 4usize];
    ["Offset of field: lysp_node_uses::refines"]
        [::std::mem::offset_of!(lysp_node_uses, refines) - 32usize];
    ["Offset of field: lysp_node_uses::augments"]
        [::std::mem::offset_of!(lysp_node_uses, augments) - 36usize];
    ["Offset of field: lysp_node_uses::when"]
        [::std::mem::offset_of!(lysp_node_uses, when) - 40usize];
};
...
const _: () = {
    ["Size of lysp_node_action_inout"]
        [::std::mem::size_of::<lysp_node_action_inout>() - 48usize];
    ["Alignment of lysp_node_action_inout"]
        [::std::mem::align_of::<lysp_node_action_inout>() - 4usize];
    ["Offset of field: lysp_node_action_inout::musts"]
        [::std::mem::offset_of!(lysp_node_action_inout, musts) - 32usize];
    ["Offset of field: lysp_node_action_inout::typedefs"]
        [::std::mem::offset_of!(lysp_node_action_inout, typedefs) - 36usize];
    ["Offset of field: lysp_node_action_inout::groupings"]
        [::std::mem::offset_of!(lysp_node_action_inout, groupings) - 40usize];
    ["Offset of field: lysp_node_action_inout::child"]
        [::std::mem::offset_of!(lysp_node_action_inout, child) - 44usize];
};
...
const _: () = {
    ["Size of lysp_node_action__bindgen_ty_1"]
        [::std::mem::size_of::<lysp_node_action__bindgen_ty_1>() - 32usize];
    ["Alignment of lysp_node_action__bindgen_ty_1"]
        [::std::mem::align_of::<lysp_node_action__bindgen_ty_1>() - 4usize];
...
const _: () = {
    ["Size of lysp_node_action"]
        [::std::mem::size_of::<lysp_node_action>() - 136usize];
    ["Alignment of lysp_node_action"]
        [::std::mem::align_of::<lysp_node_action>() - 4usize];
    ["Offset of field: lysp_node_action::typedefs"]
        [::std::mem::offset_of!(lysp_node_action, typedefs) - 32usize];
    ["Offset of field: lysp_node_action::groupings"]
        [::std::mem::offset_of!(lysp_node_action, groupings) - 36usize];
    ["Offset of field: lysp_node_action::input"]
        [::std::mem::offset_of!(lysp_node_action, input) - 40usize];
    ["Offset of field: lysp_node_action::output"]
        [::std::mem::offset_of!(lysp_node_action, output) - 88usize];
};
...
const _: () = {
    ["Size of lysp_node_notif__bindgen_ty_1"]
        [::std::mem::size_of::<lysp_node_notif__bindgen_ty_1>() - 32usize];
    ["Alignment of lysp_node_notif__bindgen_ty_1"]
        [::std::mem::align_of::<lysp_node_notif__bindgen_ty_1>() - 4usize];
...
const _: () = {
    ["Size of lysp_node_notif"]
        [::std::mem::size_of::<lysp_node_notif>() - 48usize];
    ["Alignment of lysp_node_notif"]
        [::std::mem::align_of::<lysp_node_notif>() - 4usize];
    ["Offset of field: lysp_node_notif::musts"]
        [::std::mem::offset_of!(lysp_node_notif, musts) - 32usize];
    ["Offset of field: lysp_node_notif::typedefs"]
        [::std::mem::offset_of!(lysp_node_notif, typedefs) - 36usize];
    ["Offset of field: lysp_node_notif::groupings"]
        [::std::mem::offset_of!(lysp_node_notif, groupings) - 40usize];
    ["Offset of field: lysp_node_notif::child"]
        [::std::mem::offset_of!(lysp_node_notif, child) - 44usize];
};
...
const _: () = {
    ["Size of lysp_node_grp__bindgen_ty_1"]
        [::std::mem::size_of::<lysp_node_grp__bindgen_ty_1>() - 32usize];
    ["Alignment of lysp_node_grp__bindgen_ty_1"]
        [::std::mem::align_of::<lysp_node_grp__bindgen_ty_1>() - 4usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysp_node_grp"][::std::mem::size_of::<lysp_node_grp>() - 52usize];
    ["Alignment of lysp_node_grp"]
        [::std::mem::align_of::<lysp_node_grp>() - 4usize];
    ["Offset of field: lysp_node_grp::typedefs"]
        [::std::mem::offset_of!(lysp_node_grp, typedefs) - 32usize];
    ["Offset of field: lysp_node_grp::groupings"]
        [::std::mem::offset_of!(lysp_node_grp, groupings) - 36usize];
    ["Offset of field: lysp_node_grp::child"]
        [::std::mem::offset_of!(lysp_node_grp, child) - 40usize];
    ["Offset of field: lysp_node_grp::actions"]
        [::std::mem::offset_of!(lysp_node_grp, actions) - 44usize];
    ["Offset of field: lysp_node_grp::notifs"]
        [::std::mem::offset_of!(lysp_node_grp, notifs) - 48usize];
};
...
const _: () = {
    ["Size of lysp_node_augment__bindgen_ty_1"]
        [::std::mem::size_of::<lysp_node_augment__bindgen_ty_1>() - 32usize];
    ["Alignment of lysp_node_augment__bindgen_ty_1"]
        [::std::mem::align_of::<lysp_node_augment__bindgen_ty_1>() - 4usize];
...
const _: () = {
    ["Size of lysp_node_augment"]
        [::std::mem::size_of::<lysp_node_augment>() - 48usize];
    ["Alignment of lysp_node_augment"]
        [::std::mem::align_of::<lysp_node_augment>() - 4usize];
    ["Offset of field: lysp_node_augment::child"]
        [::std::mem::offset_of!(lysp_node_augment, child) - 32usize];
    ["Offset of field: lysp_node_augment::when"]
        [::std::mem::offset_of!(lysp_node_augment, when) - 36usize];
    ["Offset of field: lysp_node_augment::actions"]
        [::std::mem::offset_of!(lysp_node_augment, actions) - 40usize];
    ["Offset of field: lysp_node_augment::notifs"]
        [::std::mem::offset_of!(lysp_node_augment, notifs) - 44usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysp_module"][::std::mem::size_of::<lysp_module>() - 64usize];
    ["Alignment of lysp_module"]
        [::std::mem::align_of::<lysp_module>() - 4usize];
    ["Offset of field: lysp_module::mod_"]
        [::std::mem::offset_of!(lysp_module, mod_) - 0usize];
    ["Offset of field: lysp_module::revs"]
        [::std::mem::offset_of!(lysp_module, revs) - 4usize];
    ["Offset of field: lysp_module::imports"]
        [::std::mem::offset_of!(lysp_module, imports) - 8usize];
    ["Offset of field: lysp_module::includes"]
        [::std::mem::offset_of!(lysp_module, includes) - 12usize];
    ["Offset of field: lysp_module::extensions"]
        [::std::mem::offset_of!(lysp_module, extensions) - 16usize];
    ["Offset of field: lysp_module::features"]
        [::std::mem::offset_of!(lysp_module, features) - 20usize];
    ["Offset of field: lysp_module::identities"]
        [::std::mem::offset_of!(lysp_module, identities) - 24usize];
    ["Offset of field: lysp_module::typedefs"]
        [::std::mem::offset_of!(lysp_module, typedefs) - 28usize];
    ["Offset of field: lysp_module::groupings"]
        [::std::mem::offset_of!(lysp_module, groupings) - 32usize];
    ["Offset of field: lysp_module::data"]
        [::std::mem::offset_of!(lysp_module, data) - 36usize];
    ["Offset of field: lysp_module::augments"]
        [::std::mem::offset_of!(lysp_module, augments) - 40usize];
    ["Offset of field: lysp_module::rpcs"]
        [::std::mem::offset_of!(lysp_module, rpcs) - 44usize];
    ["Offset of field: lysp_module::notifs"]
        [::std::mem::offset_of!(lysp_module, notifs) - 48usize];
    ["Offset of field: lysp_module::deviations"]
        [::std::mem::offset_of!(lysp_module, deviations) - 52usize];
    ["Offset of field: lysp_module::exts"]
        [::std::mem::offset_of!(lysp_module, exts) - 56usize];
    ["Offset of field: lysp_module::version"]
        [::std::mem::offset_of!(lysp_module, version) - 60usize];
};
...
const _: () = {
    ["Size of lysp_submodule"]
        [::std::mem::size_of::<lysp_submodule>() - 92usize];
    ["Alignment of lysp_submodule"]
        [::std::mem::align_of::<lysp_submodule>() - 4usize];
    ["Offset of field: lysp_submodule::mod_"]
        [::std::mem::offset_of!(lysp_submodule, mod_) - 0usize];
    ["Offset of field: lysp_submodule::revs"]
        [::std::mem::offset_of!(lysp_submodule, revs) - 4usize];
    ["Offset of field: lysp_submodule::imports"]
        [::std::mem::offset_of!(lysp_submodule, imports) - 8usize];
    ["Offset of field: lysp_submodule::includes"]
        [::std::mem::offset_of!(lysp_submodule, includes) - 12usize];
    ["Offset of field: lysp_submodule::extensions"]
        [::std::mem::offset_of!(lysp_submodule, extensions) - 16usize];
    ["Offset of field: lysp_submodule::features"]
        [::std::mem::offset_of!(lysp_submodule, features) - 20usize];
    ["Offset of field: lysp_submodule::identities"]
        [::std::mem::offset_of!(lysp_submodule, identities) - 24usize];
    ["Offset of field: lysp_submodule::typedefs"]
        [::std::mem::offset_of!(lysp_submodule, typedefs) - 28usize];
    ["Offset of field: lysp_submodule::groupings"]
        [::std::mem::offset_of!(lysp_submodule, groupings) - 32usize];
    ["Offset of field: lysp_submodule::data"]
        [::std::mem::offset_of!(lysp_submodule, data) - 36usize];
    ["Offset of field: lysp_submodule::augments"]
        [::std::mem::offset_of!(lysp_submodule, augments) - 40usize];
    ["Offset of field: lysp_submodule::rpcs"]
        [::std::mem::offset_of!(lysp_submodule, rpcs) - 44usize];
    ["Offset of field: lysp_submodule::notifs"]
        [::std::mem::offset_of!(lysp_submodule, notifs) - 48usize];
    ["Offset of field: lysp_submodule::deviations"]
        [::std::mem::offset_of!(lysp_submodule, deviations) - 52usize];
    ["Offset of field: lysp_submodule::exts"]
        [::std::mem::offset_of!(lysp_submodule, exts) - 56usize];
    ["Offset of field: lysp_submodule::version"]
        [::std::mem::offset_of!(lysp_submodule, version) - 60usize];
    ["Offset of field: lysp_submodule::name"]
        [::std::mem::offset_of!(lysp_submodule, name) - 64usize];
    ["Offset of field: lysp_submodule::filepath"]
        [::std::mem::offset_of!(lysp_submodule, filepath) - 68usize];
    ["Offset of field: lysp_submodule::prefix"]
        [::std::mem::offset_of!(lysp_submodule, prefix) - 72usize];
    ["Offset of field: lysp_submodule::org"]
        [::std::mem::offset_of!(lysp_submodule, org) - 76usize];
    ["Offset of field: lysp_submodule::contact"]
        [::std::mem::offset_of!(lysp_submodule, contact) - 80usize];
    ["Offset of field: lysp_submodule::dsc"]
        [::std::mem::offset_of!(lysp_submodule, dsc) - 84usize];
    ["Offset of field: lysp_submodule::ref_"]
        [::std::mem::offset_of!(lysp_submodule, ref_) - 88usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysc_ext"][::std::mem::size_of::<lysc_ext>() - 24usize];
    ["Alignment of lysc_ext"][::std::mem::align_of::<lysc_ext>() - 4usize];
    ["Offset of field: lysc_ext::name"]
        [::std::mem::offset_of!(lysc_ext, name) - 0usize];
    ["Offset of field: lysc_ext::argname"]
        [::std::mem::offset_of!(lysc_ext, argname) - 4usize];
    ["Offset of field: lysc_ext::exts"]
        [::std::mem::offset_of!(lysc_ext, exts) - 8usize];
    ["Offset of field: lysc_ext::plugin_ref"]
        [::std::mem::offset_of!(lysc_ext, plugin_ref) - 12usize];
    ["Offset of field: lysc_ext::module"]
        [::std::mem::offset_of!(lysc_ext, module) - 16usize];
    ["Offset of field: lysc_ext::flags"]
        [::std::mem::offset_of!(lysc_ext, flags) - 20usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysc_when"][::std::mem::size_of::<lysc_when>() - 32usize];
    ["Alignment of lysc_when"][::std::mem::align_of::<lysc_when>() - 4usize];
    ["Offset of field: lysc_when::cond"]
        [::std::mem::offset_of!(lysc_when, cond) - 0usize];
    ["Offset of field: lysc_when::context"]
        [::std::mem::offset_of!(lysc_when, context) - 4usize];
    ["Offset of field: lysc_when::prefixes"]
        [::std::mem::offset_of!(lysc_when, prefixes) - 8usize];
    ["Offset of field: lysc_when::dsc"]
        [::std::mem::offset_of!(lysc_when, dsc) - 12usize];
    ["Offset of field: lysc_when::ref_"]
        [::std::mem::offset_of!(lysc_when, ref_) - 16usize];
    ["Offset of field: lysc_when::exts"]
        [::std::mem::offset_of!(lysc_when, exts) - 20usize];
    ["Offset of field: lysc_when::refcount"]
        [::std::mem::offset_of!(lysc_when, refcount) - 24usize];
    ["Offset of field: lysc_when::flags"]
        [::std::mem::offset_of!(lysc_when, flags) - 28usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysc_ident"][::std::mem::size_of::<lysc_ident>() - 28usize];
    ["Alignment of lysc_ident"][::std::mem::align_of::<lysc_ident>() - 4usize];
    ["Offset of field: lysc_ident::name"]
        [::std::mem::offset_of!(lysc_ident, name) - 0usize];
    ["Offset of field: lysc_ident::dsc"]
        [::std::mem::offset_of!(lysc_ident, dsc) - 4usize];
    ["Offset of field: lysc_ident::ref_"]
        [::std::mem::offset_of!(lysc_ident, ref_) - 8usize];
    ["Offset of field: lysc_ident::module"]
        [::std::mem::offset_of!(lysc_ident, module) - 12usize];
    ["Offset of field: lysc_ident::derived"]
        [::std::mem::offset_of!(lysc_ident, derived) - 16usize];
    ["Offset of field: lysc_ident::exts"]
        [::std::mem::offset_of!(lysc_ident, exts) - 20usize];
    ["Offset of field: lysc_ident::flags"]
        [::std::mem::offset_of!(lysc_ident, flags) - 24usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysc_revision"][::std::mem::size_of::<lysc_revision>() - 16usize];
    ["Alignment of lysc_revision"]
        [::std::mem::align_of::<lysc_revision>() - 4usize];
    ["Offset of field: lysc_revision::date"]
        [::std::mem::offset_of!(lysc_revision, date) - 0usize];
    ["Offset of field: lysc_revision::exts"]
        [::std::mem::offset_of!(lysc_revision, exts) - 12usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysc_range"][::std::mem::size_of::<lysc_range>() - 24usize];
    ["Alignment of lysc_range"][::std::mem::align_of::<lysc_range>() - 4usize];
    ["Offset of field: lysc_range::parts"]
        [::std::mem::offset_of!(lysc_range, parts) - 0usize];
    ["Offset of field: lysc_range::dsc"]
        [::std::mem::offset_of!(lysc_range, dsc) - 4usize];
    ["Offset of field: lysc_range::ref_"]
        [::std::mem::offset_of!(lysc_range, ref_) - 8usize];
    ["Offset of field: lysc_range::emsg"]
        [::std::mem::offset_of!(lysc_range, emsg) - 12usize];
    ["Offset of field: lysc_range::eapptag"]
        [::std::mem::offset_of!(lysc_range, eapptag) - 16usize];
    ["Offset of field: lysc_range::exts"]
        [::std::mem::offset_of!(lysc_range, exts) - 20usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysc_pattern"][::std::mem::size_of::<lysc_pattern>() - 28usize];
    ["Alignment of lysc_pattern"]
        [::std::mem::align_of::<lysc_pattern>() - 4usize];
    ["Offset of field: lysc_pattern::expr"]
        [::std::mem::offset_of!(lysc_pattern, expr) - 0usize];
    ["Offset of field: lysc_pattern::dsc"]
        [::std::mem::offset_of!(lysc_pattern, dsc) - 4usize];
    ["Offset of field: lysc_pattern::ref_"]
        [::std::mem::offset_of!(lysc_pattern, ref_) - 8usize];
    ["Offset of field: lysc_pattern::emsg"]
        [::std::mem::offset_of!(lysc_pattern, emsg) - 12usize];
    ["Offset of field: lysc_pattern::eapptag"]
        [::std::mem::offset_of!(lysc_pattern, eapptag) - 16usize];
    ["Offset of field: lysc_pattern::exts"]
        [::std::mem::offset_of!(lysc_pattern, exts) - 20usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysc_must"][::std::mem::size_of::<lysc_must>() - 28usize];
    ["Alignment of lysc_must"][::std::mem::align_of::<lysc_must>() - 4usize];
    ["Offset of field: lysc_must::cond"]
        [::std::mem::offset_of!(lysc_must, cond) - 0usize];
    ["Offset of field: lysc_must::prefixes"]
        [::std::mem::offset_of!(lysc_must, prefixes) - 4usize];
    ["Offset of field: lysc_must::dsc"]
        [::std::mem::offset_of!(lysc_must, dsc) - 8usize];
    ["Offset of field: lysc_must::ref_"]
        [::std::mem::offset_of!(lysc_must, ref_) - 12usize];
    ["Offset of field: lysc_must::emsg"]
        [::std::mem::offset_of!(lysc_must, emsg) - 16usize];
    ["Offset of field: lysc_must::eapptag"]
        [::std::mem::offset_of!(lysc_must, eapptag) - 20usize];
    ["Offset of field: lysc_must::exts"]
        [::std::mem::offset_of!(lysc_must, exts) - 24usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysc_type"][::std::mem::size_of::<lysc_type>() - 20usize];
    ["Alignment of lysc_type"][::std::mem::align_of::<lysc_type>() - 4usize];
    ["Offset of field: lysc_type::name"]
        [::std::mem::offset_of!(lysc_type, name) - 0usize];
    ["Offset of field: lysc_type::exts"]
        [::std::mem::offset_of!(lysc_type, exts) - 4usize];
    ["Offset of field: lysc_type::plugin_ref"]
        [::std::mem::offset_of!(lysc_type, plugin_ref) - 8usize];
    ["Offset of field: lysc_type::basetype"]
        [::std::mem::offset_of!(lysc_type, basetype) - 12usize];
    ["Offset of field: lysc_type::refcount"]
        [::std::mem::offset_of!(lysc_type, refcount) - 16usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysc_type_num"][::std::mem::size_of::<lysc_type_num>() - 24usize];
    ["Alignment of lysc_type_num"]
        [::std::mem::align_of::<lysc_type_num>() - 4usize];
    ["Offset of field: lysc_type_num::name"]
        [::std::mem::offset_of!(lysc_type_num, name) - 0usize];
    ["Offset of field: lysc_type_num::exts"]
        [::std::mem::offset_of!(lysc_type_num, exts) - 4usize];
    ["Offset of field: lysc_type_num::plugin_ref"]
        [::std::mem::offset_of!(lysc_type_num, plugin_ref) - 8usize];
    ["Offset of field: lysc_type_num::basetype"]
        [::std::mem::offset_of!(lysc_type_num, basetype) - 12usize];
    ["Offset of field: lysc_type_num::refcount"]
        [::std::mem::offset_of!(lysc_type_num, refcount) - 16usize];
    ["Offset of field: lysc_type_num::range"]
        [::std::mem::offset_of!(lysc_type_num, range) - 20usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysc_type_dec"][::std::mem::size_of::<lysc_type_dec>() - 28usize];
    ["Alignment of lysc_type_dec"]
        [::std::mem::align_of::<lysc_type_dec>() - 4usize];
    ["Offset of field: lysc_type_dec::name"]
        [::std::mem::offset_of!(lysc_type_dec, name) - 0usize];
    ["Offset of field: lysc_type_dec::exts"]
        [::std::mem::offset_of!(lysc_type_dec, exts) - 4usize];
    ["Offset of field: lysc_type_dec::plugin_ref"]
        [::std::mem::offset_of!(lysc_type_dec, plugin_ref) - 8usize];
    ["Offset of field: lysc_type_dec::basetype"]
        [::std::mem::offset_of!(lysc_type_dec, basetype) - 12usize];
    ["Offset of field: lysc_type_dec::refcount"]
        [::std::mem::offset_of!(lysc_type_dec, refcount) - 16usize];
    ["Offset of field: lysc_type_dec::fraction_digits"]
        [::std::mem::offset_of!(lysc_type_dec, fraction_digits) - 20usize];
    ["Offset of field: lysc_type_dec::range"]
        [::std::mem::offset_of!(lysc_type_dec, range) - 24usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysc_type_str"][::std::mem::size_of::<lysc_type_str>() - 28usize];
    ["Alignment of lysc_type_str"]
        [::std::mem::align_of::<lysc_type_str>() - 4usize];
    ["Offset of field: lysc_type_str::name"]
        [::std::mem::offset_of!(lysc_type_str, name) - 0usize];
    ["Offset of field: lysc_type_str::exts"]
        [::std::mem::offset_of!(lysc_type_str, exts) - 4usize];
    ["Offset of field: lysc_type_str::plugin_ref"]
        [::std::mem::offset_of!(lysc_type_str, plugin_ref) - 8usize];
    ["Offset of field: lysc_type_str::basetype"]
        [::std::mem::offset_of!(lysc_type_str, basetype) - 12usize];
    ["Offset of field: lysc_type_str::refcount"]
        [::std::mem::offset_of!(lysc_type_str, refcount) - 16usize];
    ["Offset of field: lysc_type_str::length"]
        [::std::mem::offset_of!(lysc_type_str, length) - 20usize];
    ["Offset of field: lysc_type_str::patterns"]
        [::std::mem::offset_of!(lysc_type_str, patterns) - 24usize];
};
...
const _: () = {
    ["Size of lysc_type_bitenum_item"]
        [::std::mem::size_of::<lysc_type_bitenum_item>() - 24usize];
    ["Alignment of lysc_type_bitenum_item"]
        [::std::mem::align_of::<lysc_type_bitenum_item>() - 4usize];
    ...
    ["Offset of field: lysc_type_bitenum_item::dsc"]
        [::std::mem::offset_of!(lysc_type_bitenum_item, dsc) - 4usize];
    ["Offset of field: lysc_type_bitenum_item::ref_"]
        [::std::mem::offset_of!(lysc_type_bitenum_item, ref_) - 8usize];
    ["Offset of field: lysc_type_bitenum_item::exts"]
        [::std::mem::offset_of!(lysc_type_bitenum_item, exts) - 12usize];
    ["Offset of field: lysc_type_bitenum_item::flags"]
        [::std::mem::offset_of!(lysc_type_bitenum_item, flags) - 20usize];
};
...
const _: () = {
    ["Size of lysc_type_enum"]
        [::std::mem::size_of::<lysc_type_enum>() - 24usize];
    ["Alignment of lysc_type_enum"]
        [::std::mem::align_of::<lysc_type_enum>() - 4usize];
    ["Offset of field: lysc_type_enum::name"]
        [::std::mem::offset_of!(lysc_type_enum, name) - 0usize];
    ["Offset of field: lysc_type_enum::exts"]
        [::std::mem::offset_of!(lysc_type_enum, exts) - 4usize];
    ["Offset of field: lysc_type_enum::plugin_ref"]
        [::std::mem::offset_of!(lysc_type_enum, plugin_ref) - 8usize];
    ["Offset of field: lysc_type_enum::basetype"]
        [::std::mem::offset_of!(lysc_type_enum, basetype) - 12usize];
    ["Offset of field: lysc_type_enum::refcount"]
        [::std::mem::offset_of!(lysc_type_enum, refcount) - 16usize];
    ["Offset of field: lysc_type_enum::enums"]
        [::std::mem::offset_of!(lysc_type_enum, enums) - 20usize];
};
...
const _: () = {
    ["Size of lysc_type_bits"]
        [::std::mem::size_of::<lysc_type_bits>() - 24usize];
    ["Alignment of lysc_type_bits"]
        [::std::mem::align_of::<lysc_type_bits>() - 4usize];
    ["Offset of field: lysc_type_bits::name"]
        [::std::mem::offset_of!(lysc_type_bits, name) - 0usize];
    ["Offset of field: lysc_type_bits::exts"]
        [::std::mem::offset_of!(lysc_type_bits, exts) - 4usize];
    ["Offset of field: lysc_type_bits::plugin_ref"]
        [::std::mem::offset_of!(lysc_type_bits, plugin_ref) - 8usize];
    ["Offset of field: lysc_type_bits::basetype"]
        [::std::mem::offset_of!(lysc_type_bits, basetype) - 12usize];
    ["Offset of field: lysc_type_bits::refcount"]
        [::std::mem::offset_of!(lysc_type_bits, refcount) - 16usize];
    ["Offset of field: lysc_type_bits::bits"]
        [::std::mem::offset_of!(lysc_type_bits, bits) - 20usize];
};
...
const _: () = {
    ["Size of lysc_type_leafref"]
        [::std::mem::size_of::<lysc_type_leafref>() - 36usize];
    ["Alignment of lysc_type_leafref"]
        [::std::mem::align_of::<lysc_type_leafref>() - 4usize];
    ...
    ["Offset of field: lysc_type_leafref::exts"]
        [::std::mem::offset_of!(lysc_type_leafref, exts) - 4usize];
    ["Offset of field: lysc_type_leafref::plugin_ref"]
        [::std::mem::offset_of!(lysc_type_leafref, plugin_ref) - 8usize];
    ["Offset of field: lysc_type_leafref::basetype"]
        [::std::mem::offset_of!(lysc_type_leafref, basetype) - 12usize];
    ["Offset of field: lysc_type_leafref::refcount"]
        [::std::mem::offset_of!(lysc_type_leafref, refcount) - 16usize];
    ["Offset of field: lysc_type_leafref::path"]
        [::std::mem::offset_of!(lysc_type_leafref, path) - 20usize];
    ["Offset of field: lysc_type_leafref::prefixes"]
        [::std::mem::offset_of!(lysc_type_leafref, prefixes) - 24usize];
    ["Offset of field: lysc_type_leafref::realtype"]
        [::std::mem::offset_of!(lysc_type_leafref, realtype) - 28usize];
    ["Offset of field: lysc_type_leafref::require_instance"]
        [::std::mem::offset_of!(lysc_type_leafref, require_instance) - 32usize];
};
...
const _: () = {
    ["Size of lysc_type_identityref"]
        [::std::mem::size_of::<lysc_type_identityref>() - 24usize];
    ["Alignment of lysc_type_identityref"]
        [::std::mem::align_of::<lysc_type_identityref>() - 4usize];
    ...
    ["Offset of field: lysc_type_identityref::exts"]
        [::std::mem::offset_of!(lysc_type_identityref, exts) - 4usize];
    ["Offset of field: lysc_type_identityref::plugin_ref"]
        [::std::mem::offset_of!(lysc_type_identityref, plugin_ref) - 8usize];
    ["Offset of field: lysc_type_identityref::basetype"]
        [::std::mem::offset_of!(lysc_type_identityref, basetype) - 12usize];
    ["Offset of field: lysc_type_identityref::refcount"]
        [::std::mem::offset_of!(lysc_type_identityref, refcount) - 16usize];
    ["Offset of field: lysc_type_identityref::bases"]
        [::std::mem::offset_of!(lysc_type_identityref, bases) - 20usize];
};
...
const _: () = {
    ["Size of lysc_type_instanceid"]
        [::std::mem::size_of::<lysc_type_instanceid>() - 24usize];
    ["Alignment of lysc_type_instanceid"]
        [::std::mem::align_of::<lysc_type_instanceid>() - 4usize];
    ...
    ["Offset of field: lysc_type_instanceid::exts"]
        [::std::mem::offset_of!(lysc_type_instanceid, exts) - 4usize];
    ["Offset of field: lysc_type_instanceid::plugin_ref"]
        [::std::mem::offset_of!(lysc_type_instanceid, plugin_ref) - 8usize];
    ["Offset of field: lysc_type_instanceid::basetype"]
        [::std::mem::offset_of!(lysc_type_instanceid, basetype) - 12usize];
    ["Offset of field: lysc_type_instanceid::refcount"]
        [::std::mem::offset_of!(lysc_type_instanceid, refcount) - 16usize];
...
const _: () = {
    ["Size of lysc_type_union"]
        [::std::mem::size_of::<lysc_type_union>() - 24usize];
    ["Alignment of lysc_type_union"]
        [::std::mem::align_of::<lysc_type_union>() - 4usize];
    ["Offset of field: lysc_type_union::name"]
        [::std::mem::offset_of!(lysc_type_union, name) - 0usize];
    ["Offset of field: lysc_type_union::exts"]
        [::std::mem::offset_of!(lysc_type_union, exts) - 4usize];
    ["Offset of field: lysc_type_union::plugin_ref"]
        [::std::mem::offset_of!(lysc_type_union, plugin_ref) - 8usize];
    ["Offset of field: lysc_type_union::basetype"]
        [::std::mem::offset_of!(lysc_type_union, basetype) - 12usize];
    ["Offset of field: lysc_type_union::refcount"]
        [::std::mem::offset_of!(lysc_type_union, refcount) - 16usize];
    ["Offset of field: lysc_type_union::types"]
        [::std::mem::offset_of!(lysc_type_union, types) - 20usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysc_type_bin"][::std::mem::size_of::<lysc_type_bin>() - 24usize];
    ["Alignment of lysc_type_bin"]
        [::std::mem::align_of::<lysc_type_bin>() - 4usize];
    ["Offset of field: lysc_type_bin::name"]
        [::std::mem::offset_of!(lysc_type_bin, name) - 0usize];
    ["Offset of field: lysc_type_bin::exts"]
        [::std::mem::offset_of!(lysc_type_bin, exts) - 4usize];
    ["Offset of field: lysc_type_bin::plugin_ref"]
        [::std::mem::offset_of!(lysc_type_bin, plugin_ref) - 8usize];
    ["Offset of field: lysc_type_bin::basetype"]
        [::std::mem::offset_of!(lysc_type_bin, basetype) - 12usize];
    ["Offset of field: lysc_type_bin::refcount"]
        [::std::mem::offset_of!(lysc_type_bin, refcount) - 16usize];
    ["Offset of field: lysc_type_bin::length"]
        [::std::mem::offset_of!(lysc_type_bin, length) - 20usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysc_node"][::std::mem::size_of::<lysc_node>() - 44usize];
    ["Alignment of lysc_node"][::std::mem::align_of::<lysc_node>() - 4usize];
    ...
    ["Offset of field: lysc_node::parent"]
        [::std::mem::offset_of!(lysc_node, parent) - 12usize];
    ["Offset of field: lysc_node::next"]
        [::std::mem::offset_of!(lysc_node, next) - 16usize];
    ["Offset of field: lysc_node::prev"]
        [::std::mem::offset_of!(lysc_node, prev) - 20usize];
    ["Offset of field: lysc_node::name"]
        [::std::mem::offset_of!(lysc_node, name) - 24usize];
    ["Offset of field: lysc_node::dsc"]
        [::std::mem::offset_of!(lysc_node, dsc) - 28usize];
    ["Offset of field: lysc_node::ref_"]
        [::std::mem::offset_of!(lysc_node, ref_) - 32usize];
    ["Offset of field: lysc_node::exts"]
        [::std::mem::offset_of!(lysc_node, exts) - 36usize];
    ["Offset of field: lysc_node::priv_"]
        [::std::mem::offset_of!(lysc_node, priv_) - 40usize];
};
...
const _: () = {
    ["Size of lysc_node_action_inout"]
        [::std::mem::size_of::<lysc_node_action_inout>() - 52usize];
    ["Alignment of lysc_node_action_inout"]
        [::std::mem::align_of::<lysc_node_action_inout>() - 4usize];
    ["Offset of field: lysc_node_action_inout::child"]
        [::std::mem::offset_of!(lysc_node_action_inout, child) - 44usize];
    ["Offset of field: lysc_node_action_inout::musts"]
        [::std::mem::offset_of!(lysc_node_action_inout, musts) - 48usize];
};
...
const _: () = {
    ["Size of lysc_node_action__bindgen_ty_1"]
        [::std::mem::size_of::<lysc_node_action__bindgen_ty_1>() - 44usize];
    ["Alignment of lysc_node_action__bindgen_ty_1"]
        [::std::mem::align_of::<lysc_node_action__bindgen_ty_1>() - 4usize];
...
const _: () = {
    ["Size of lysc_node_action"]
        [::std::mem::size_of::<lysc_node_action>() - 152usize];
    ["Alignment of lysc_node_action"]
        [::std::mem::align_of::<lysc_node_action>() - 4usize];
    ["Offset of field: lysc_node_action::when"]
        [::std::mem::offset_of!(lysc_node_action, when) - 44usize];
    ["Offset of field: lysc_node_action::input"]
        [::std::mem::offset_of!(lysc_node_action, input) - 48usize];
    ["Offset of field: lysc_node_action::output"]
        [::std::mem::offset_of!(lysc_node_action, output) - 100usize];
};
...
const _: () = {
    ["Size of lysc_node_notif__bindgen_ty_1"]
        [::std::mem::size_of::<lysc_node_notif__bindgen_ty_1>() - 44usize];
    ["Alignment of lysc_node_notif__bindgen_ty_1"]
        [::std::mem::align_of::<lysc_node_notif__bindgen_ty_1>() - 4usize];
...
const _: () = {
    ["Size of lysc_node_notif"]
        [::std::mem::size_of::<lysc_node_notif>() - 56usize];
    ["Alignment of lysc_node_notif"]
        [::std::mem::align_of::<lysc_node_notif>() - 4usize];
    ["Offset of field: lysc_node_notif::child"]
        [::std::mem::offset_of!(lysc_node_notif, child) - 44usize];
    ["Offset of field: lysc_node_notif::musts"]
        [::std::mem::offset_of!(lysc_node_notif, musts) - 48usize];
    ["Offset of field: lysc_node_notif::when"]
        [::std::mem::offset_of!(lysc_node_notif, when) - 52usize];
};
...
const _: () = {
    ["Size of lysc_node_container__bindgen_ty_1"]
        [::std::mem::size_of::<lysc_node_container__bindgen_ty_1>() - 44usize];
    ["Alignment of lysc_node_container__bindgen_ty_1"]
        [::std::mem::align_of::<lysc_node_container__bindgen_ty_1>() - 4usize];
...
const _: () = {
    ["Size of lysc_node_container"]
        [::std::mem::size_of::<lysc_node_container>() - 64usize];
    ["Alignment of lysc_node_container"]
        [::std::mem::align_of::<lysc_node_container>() - 4usize];
    ["Offset of field: lysc_node_container::child"]
        [::std::mem::offset_of!(lysc_node_container, child) - 44usize];
    ["Offset of field: lysc_node_container::musts"]
        [::std::mem::offset_of!(lysc_node_container, musts) - 48usize];
    ["Offset of field: lysc_node_container::when"]
        [::std::mem::offset_of!(lysc_node_container, when) - 52usize];
    ["Offset of field: lysc_node_container::actions"]
        [::std::mem::offset_of!(lysc_node_container, actions) - 56usize];
    ["Offset of field: lysc_node_container::notifs"]
        [::std::mem::offset_of!(lysc_node_container, notifs) - 60usize];
};
...
const _: () = {
    ["Size of lysc_node_case__bindgen_ty_1"]
        [::std::mem::size_of::<lysc_node_case__bindgen_ty_1>() - 44usize];
    ["Alignment of lysc_node_case__bindgen_ty_1"]
        [::std::mem::align_of::<lysc_node_case__bindgen_ty_1>() - 4usize];
...
const _: () = {
    ["Size of lysc_node_case"]
        [::std::mem::size_of::<lysc_node_case>() - 52usize];
    ["Alignment of lysc_node_case"]
        [::std::mem::align_of::<lysc_node_case>() - 4usize];
    ["Offset of field: lysc_node_case::child"]
        [::std::mem::offset_of!(lysc_node_case, child) - 44usize];
    ["Offset of field: lysc_node_case::when"]
        [::std::mem::offset_of!(lysc_node_case, when) - 48usize];
};
...
const _: () = {
    ["Size of lysc_node_choice__bindgen_ty_1"]
        [::std::mem::size_of::<lysc_node_choice__bindgen_ty_1>() - 44usize];
    ["Alignment of lysc_node_choice__bindgen_ty_1"]
        [::std::mem::align_of::<lysc_node_choice__bindgen_ty_1>() - 4usize];
...
const _: () = {
    ["Size of lysc_node_choice"]
        [::std::mem::size_of::<lysc_node_choice>() - 56usize];
    ["Alignment of lysc_node_choice"]
        [::std::mem::align_of::<lysc_node_choice>() - 4usize];
    ["Offset of field: lysc_node_choice::cases"]
        [::std::mem::offset_of!(lysc_node_choice, cases) - 44usize];
    ["Offset of field: lysc_node_choice::when"]
        [::std::mem::offset_of!(lysc_node_choice, when) - 48usize];
    ["Offset of field: lysc_node_choice::dflt"]
        [::std::mem::offset_of!(lysc_node_choice, dflt) - 52usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysc_value"][::std::mem::size_of::<lysc_value>() - 8usize];
    ["Alignment of lysc_value"][::std::mem::align_of::<lysc_value>() - 4usize];
    ["Offset of field: lysc_value::str_"]
        [::std::mem::offset_of!(lysc_value, str_) - 0usize];
    ["Offset of field: lysc_value::prefixes"]
        [::std::mem::offset_of!(lysc_value, prefixes) - 4usize];
};
...
const _: () = {
    ["Size of lysc_node_leaf__bindgen_ty_1"]
        [::std::mem::size_of::<lysc_node_leaf__bindgen_ty_1>() - 44usize];
    ["Alignment of lysc_node_leaf__bindgen_ty_1"]
        [::std::mem::align_of::<lysc_node_leaf__bindgen_ty_1>() - 4usize];
...
const _: () = {
    ["Size of lysc_node_leaf"]
        [::std::mem::size_of::<lysc_node_leaf>() - 68usize];
    ["Alignment of lysc_node_leaf"]
        [::std::mem::align_of::<lysc_node_leaf>() - 4usize];
    ["Offset of field: lysc_node_leaf::musts"]
        [::std::mem::offset_of!(lysc_node_leaf, musts) - 44usize];
    ["Offset of field: lysc_node_leaf::when"]
        [::std::mem::offset_of!(lysc_node_leaf, when) - 48usize];
    ["Offset of field: lysc_node_leaf::type_"]
        [::std::mem::offset_of!(lysc_node_leaf, type_) - 52usize];
    ["Offset of field: lysc_node_leaf::units"]
        [::std::mem::offset_of!(lysc_node_leaf, units) - 56usize];
    ["Offset of field: lysc_node_leaf::dflt"]
        [::std::mem::offset_of!(lysc_node_leaf, dflt) - 60usize];
};
...
const _: () = {
    ["Size of lysc_node_leaflist__bindgen_ty_1"]
        [::std::mem::size_of::<lysc_node_leaflist__bindgen_ty_1>() - 44usize];
    ["Alignment of lysc_node_leaflist__bindgen_ty_1"]
        [::std::mem::align_of::<lysc_node_leaflist__bindgen_ty_1>() - 4usize];
...
const _: () = {
    ["Size of lysc_node_leaflist"]
        [::std::mem::size_of::<lysc_node_leaflist>() - 72usize];
    ["Alignment of lysc_node_leaflist"]
        [::std::mem::align_of::<lysc_node_leaflist>() - 4usize];
    ["Offset of field: lysc_node_leaflist::musts"]
        [::std::mem::offset_of!(lysc_node_leaflist, musts) - 44usize];
    ["Offset of field: lysc_node_leaflist::when"]
        [::std::mem::offset_of!(lysc_node_leaflist, when) - 48usize];
    ["Offset of field: lysc_node_leaflist::type_"]
        [::std::mem::offset_of!(lysc_node_leaflist, type_) - 52usize];
    ["Offset of field: lysc_node_leaflist::units"]
        [::std::mem::offset_of!(lysc_node_leaflist, units) - 56usize];
    ["Offset of field: lysc_node_leaflist::dflts"]
        [::std::mem::offset_of!(lysc_node_leaflist, dflts) - 60usize];
    ["Offset of field: lysc_node_leaflist::min"]
        [::std::mem::offset_of!(lysc_node_leaflist, min) - 64usize];
    ["Offset of field: lysc_node_leaflist::max"]
        [::std::mem::offset_of!(lysc_node_leaflist, max) - 68usize];
};
...
const _: () = {
    ["Size of lysc_node_list__bindgen_ty_1"]
        [::std::mem::size_of::<lysc_node_list__bindgen_ty_1>() - 44usize];
    ["Alignment of lysc_node_list__bindgen_ty_1"]
        [::std::mem::align_of::<lysc_node_list__bindgen_ty_1>() - 4usize];
...
const _: () = {
    ["Size of lysc_node_list"]
        [::std::mem::size_of::<lysc_node_list>() - 76usize];
    ["Alignment of lysc_node_list"]
        [::std::mem::align_of::<lysc_node_list>() - 4usize];
    ["Offset of field: lysc_node_list::child"]
        [::std::mem::offset_of!(lysc_node_list, child) - 44usize];
    ["Offset of field: lysc_node_list::musts"]
        [::std::mem::offset_of!(lysc_node_list, musts) - 48usize];
    ["Offset of field: lysc_node_list::when"]
        [::std::mem::offset_of!(lysc_node_list, when) - 52usize];
    ["Offset of field: lysc_node_list::actions"]
        [::std::mem::offset_of!(lysc_node_list, actions) - 56usize];
    ["Offset of field: lysc_node_list::notifs"]
        [::std::mem::offset_of!(lysc_node_list, notifs) - 60usize];
    ["Offset of field: lysc_node_list::uniques"]
        [::std::mem::offset_of!(lysc_node_list, uniques) - 64usize];
    ["Offset of field: lysc_node_list::min"]
        [::std::mem::offset_of!(lysc_node_list, min) - 68usize];
    ["Offset of field: lysc_node_list::max"]
        [::std::mem::offset_of!(lysc_node_list, max) - 72usize];
};
...
const _: () = {
    ["Size of lysc_node_anydata__bindgen_ty_1"]
        [::std::mem::size_of::<lysc_node_anydata__bindgen_ty_1>() - 44usize];
    ["Alignment of lysc_node_anydata__bindgen_ty_1"]
        [::std::mem::align_of::<lysc_node_anydata__bindgen_ty_1>() - 4usize];
...
const _: () = {
    ["Size of lysc_node_anydata"]
        [::std::mem::size_of::<lysc_node_anydata>() - 52usize];
    ["Alignment of lysc_node_anydata"]
        [::std::mem::align_of::<lysc_node_anydata>() - 4usize];
    ["Offset of field: lysc_node_anydata::musts"]
        [::std::mem::offset_of!(lysc_node_anydata, musts) - 44usize];
    ["Offset of field: lysc_node_anydata::when"]
        [::std::mem::offset_of!(lysc_node_anydata, when) - 48usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lys_module"][::std::mem::size_of::<lys_module>() - 72usize];
    ["Alignment of lys_module"][::std::mem::align_of::<lys_module>() - 4usize];
    ["Offset of field: lys_module::ctx"]
        [::std::mem::offset_of!(lys_module, ctx) - 0usize];
    ["Offset of field: lys_module::name"]
        [::std::mem::offset_of!(lys_module, name) - 4usize];
    ["Offset of field: lys_module::revision"]
        [::std::mem::offset_of!(lys_module, revision) - 8usize];
    ["Offset of field: lys_module::ns"]
        [::std::mem::offset_of!(lys_module, ns) - 12usize];
    ["Offset of field: lys_module::prefix"]
        [::std::mem::offset_of!(lys_module, prefix) - 16usize];
    ["Offset of field: lys_module::filepath"]
        [::std::mem::offset_of!(lys_module, filepath) - 20usize];
    ["Offset of field: lys_module::org"]
        [::std::mem::offset_of!(lys_module, org) - 24usize];
    ["Offset of field: lys_module::contact"]
        [::std::mem::offset_of!(lys_module, contact) - 28usize];
    ["Offset of field: lys_module::dsc"]
        [::std::mem::offset_of!(lys_module, dsc) - 32usize];
    ["Offset of field: lys_module::ref_"]
        [::std::mem::offset_of!(lys_module, ref_) - 36usize];
    ["Offset of field: lys_module::parsed"]
        [::std::mem::offset_of!(lys_module, parsed) - 40usize];
    ["Offset of field: lys_module::compiled"]
        [::std::mem::offset_of!(lys_module, compiled) - 44usize];
    ["Offset of field: lys_module::extensions"]
        [::std::mem::offset_of!(lys_module, extensions) - 48usize];
    ["Offset of field: lys_module::identities"]
        [::std::mem::offset_of!(lys_module, identities) - 52usize];
    ["Offset of field: lys_module::submodules"]
        [::std::mem::offset_of!(lys_module, submodules) - 56usize];
    ["Offset of field: lys_module::augmented_by"]
        [::std::mem::offset_of!(lys_module, augmented_by) - 60usize];
    ["Offset of field: lys_module::deviated_by"]
        [::std::mem::offset_of!(lys_module, deviated_by) - 64usize];
    ["Offset of field: lys_module::implemented"]
        [::std::mem::offset_of!(lys_module, implemented) - 68usize];
    ["Offset of field: lys_module::to_compile"]
        [::std::mem::offset_of!(lys_module, to_compile) - 69usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lyd_value"][::std::mem::size_of::<lyd_value>() - 32usize];
    ...
    ["Offset of field: lyd_value::realtype"]
        [::std::mem::offset_of!(lyd_value, realtype) - 4usize];
};
...
const _: () = {
    ["Size of lyd_value_union"]
        [::std::mem::size_of::<lyd_value_union>() - 64usize];
    ...
    ["Offset of field: lyd_value_union::original"]
        [::std::mem::offset_of!(lyd_value_union, original) - 32usize];
    ["Offset of field: lyd_value_union::orig_size_bits"]
        [::std::mem::offset_of!(lyd_value_union, orig_size_bits) - 40usize];
    ["Offset of field: lyd_value_union::hints"]
        [::std::mem::offset_of!(lyd_value_union, hints) - 48usize];
    ["Offset of field: lyd_value_union::format"]
        [::std::mem::offset_of!(lyd_value_union, format) - 52usize];
    ["Offset of field: lyd_value_union::prefix_data"]
        [::std::mem::offset_of!(lyd_value_union, prefix_data) - 56usize];
    ["Offset of field: lyd_value_union::ctx_node"]
        [::std::mem::offset_of!(lyd_value_union, ctx_node) - 60usize];
};
...
const _: () = {
    ["Size of lyd_value_ipv4_address"]
        [::std::mem::size_of::<lyd_value_ipv4_address>() - 8usize];
    ["Alignment of lyd_value_ipv4_address"]
        [::std::mem::align_of::<lyd_value_ipv4_address>() - 4usize];
    ...
    ["Offset of field: lyd_value_ipv4_address::zone"]
        [::std::mem::offset_of!(lyd_value_ipv4_address, zone) - 4usize];
};
...
const _: () = {
    ["Size of lyd_value_ipv6_address"]
        [::std::mem::size_of::<lyd_value_ipv6_address>() - 20usize];
    ["Alignment of lyd_value_ipv6_address"]
        [::std::mem::align_of::<lyd_value_ipv6_address>() - 4usize];
...
const _: () = {
    ["Size of lyd_value_date_and_time"]
        [::std::mem::size_of::<lyd_value_date_and_time>() - 16usize];
    ...
    ["Offset of field: lyd_value_date_and_time::unknown_tz"]
        [::std::mem::offset_of!(lyd_value_date_and_time, unknown_tz) - 12usize];
};
...
const _: () = {
    ["Size of lyd_value_time"]
        [::std::mem::size_of::<lyd_value_time>() - 12usize];
    ["Alignment of lyd_value_time"]
        [::std::mem::align_of::<lyd_value_time>() - 4usize];
    ...
    ["Offset of field: lyd_value_time::fractions_s"]
        [::std::mem::offset_of!(lyd_value_time, fractions_s) - 4usize];
    ["Offset of field: lyd_value_time::unknown_tz"]
        [::std::mem::offset_of!(lyd_value_time, unknown_tz) - 8usize];
};
...
const _: () = {
    ["Size of lyd_value_time_nz"]
        [::std::mem::size_of::<lyd_value_time_nz>() - 8usize];
    ["Alignment of lyd_value_time_nz"]
        [::std::mem::align_of::<lyd_value_time_nz>() - 4usize];
    ...
    ["Offset of field: lyd_value_time_nz::fractions_s"]
        [::std::mem::offset_of!(lyd_value_time_nz, fractions_s) - 4usize];
};
...
const _: () = {
    ["Size of lyd_value_lyds_tree"]
        [::std::mem::size_of::<lyd_value_lyds_tree>() - 4usize];
    ["Alignment of lyd_value_lyds_tree"]
        [::std::mem::align_of::<lyd_value_lyds_tree>() - 4usize];
...
const _: () = {
    ["Size of ly_opaq_name__bindgen_ty_1"]
        [::std::mem::size_of::<ly_opaq_name__bindgen_ty_1>() - 4usize];
    ["Alignment of ly_opaq_name__bindgen_ty_1"]
        [::std::mem::align_of::<ly_opaq_name__bindgen_ty_1>() - 4usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ly_opaq_name"][::std::mem::size_of::<ly_opaq_name>() - 12usize];
    ["Alignment of ly_opaq_name"]
        [::std::mem::align_of::<ly_opaq_name>() - 4usize];
    ["Offset of field: ly_opaq_name::name"]
        [::std::mem::offset_of!(ly_opaq_name, name) - 0usize];
    ["Offset of field: ly_opaq_name::prefix"]
        [::std::mem::offset_of!(ly_opaq_name, prefix) - 4usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lyd_attr"][::std::mem::size_of::<lyd_attr>() - 36usize];
    ["Alignment of lyd_attr"][::std::mem::align_of::<lyd_attr>() - 4usize];
    ["Offset of field: lyd_attr::parent"]
        [::std::mem::offset_of!(lyd_attr, parent) - 0usize];
    ["Offset of field: lyd_attr::next"]
        [::std::mem::offset_of!(lyd_attr, next) - 4usize];
    ["Offset of field: lyd_attr::name"]
        [::std::mem::offset_of!(lyd_attr, name) - 8usize];
    ["Offset of field: lyd_attr::value"]
        [::std::mem::offset_of!(lyd_attr, value) - 20usize];
    ["Offset of field: lyd_attr::hints"]
        [::std::mem::offset_of!(lyd_attr, hints) - 24usize];
    ["Offset of field: lyd_attr::format"]
        [::std::mem::offset_of!(lyd_attr, format) - 28usize];
    ["Offset of field: lyd_attr::val_prefix_data"]
        [::std::mem::offset_of!(lyd_attr, val_prefix_data) - 32usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lyd_node"][::std::mem::size_of::<lyd_node>() - 32usize];
    ["Alignment of lyd_node"][::std::mem::align_of::<lyd_node>() - 4usize];
    ...
    ["Offset of field: lyd_node::parent"]
        [::std::mem::offset_of!(lyd_node, parent) - 12usize];
    ["Offset of field: lyd_node::next"]
        [::std::mem::offset_of!(lyd_node, next) - 16usize];
    ["Offset of field: lyd_node::prev"]
        [::std::mem::offset_of!(lyd_node, prev) - 20usize];
    ["Offset of field: lyd_node::meta"]
        [::std::mem::offset_of!(lyd_node, meta) - 24usize];
    ["Offset of field: lyd_node::priv_"]
        [::std::mem::offset_of!(lyd_node, priv_) - 28usize];
};
...
const _: () = {
    ["Size of lyd_node_inner__bindgen_ty_1"]
        [::std::mem::size_of::<lyd_node_inner__bindgen_ty_1>() - 32usize];
    ["Alignment of lyd_node_inner__bindgen_ty_1"]
        [::std::mem::align_of::<lyd_node_inner__bindgen_ty_1>() - 4usize];
...
const _: () = {
    ["Size of lyd_node_inner"]
        [::std::mem::size_of::<lyd_node_inner>() - 40usize];
    ["Alignment of lyd_node_inner"]
        [::std::mem::align_of::<lyd_node_inner>() - 4usize];
    ["Offset of field: lyd_node_inner::child"]
        [::std::mem::offset_of!(lyd_node_inner, child) - 32usize];
    ["Offset of field: lyd_node_inner::children_ht"]
        [::std::mem::offset_of!(lyd_node_inner, children_ht) - 36usize];
};
...
const _: () = {
    ["Size of lyd_node_term__bindgen_ty_1"]
        [::std::mem::size_of::<lyd_node_term__bindgen_ty_1>() - 32usize];
    ["Alignment of lyd_node_term__bindgen_ty_1"]
        [::std::mem::align_of::<lyd_node_term__bindgen_ty_1>() - 4usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lyd_node_term"][::std::mem::size_of::<lyd_node_term>() - 64usize];
    ["Alignment of lyd_node_term"]
        [::std::mem::align_of::<lyd_node_term>() - 8usize];
    ["Offset of field: lyd_node_term::value"]
        [::std::mem::offset_of!(lyd_node_term, value) - 32usize];
};
...
const _: () = {
    ["Size of lyd_node_any__bindgen_ty_1"]
        [::std::mem::size_of::<lyd_node_any__bindgen_ty_1>() - 32usize];
    ["Alignment of lyd_node_any__bindgen_ty_1"]
        [::std::mem::align_of::<lyd_node_any__bindgen_ty_1>() - 4usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lyd_node_any"][::std::mem::size_of::<lyd_node_any>() - 48usize];
    ["Alignment of lyd_node_any"]
        [::std::mem::align_of::<lyd_node_any>() - 4usize];
    ["Offset of field: lyd_node_any::child"]
        [::std::mem::offset_of!(lyd_node_any, child) - 32usize];
    ["Offset of field: lyd_node_any::children_ht"]
        [::std::mem::offset_of!(lyd_node_any, children_ht) - 36usize];
    ["Offset of field: lyd_node_any::value"]
        [::std::mem::offset_of!(lyd_node_any, value) - 40usize];
    ["Offset of field: lyd_node_any::hints"]
        [::std::mem::offset_of!(lyd_node_any, hints) - 44usize];
};
...
const _: () = {
    ["Size of lyd_node_opaq__bindgen_ty_1"]
        [::std::mem::size_of::<lyd_node_opaq__bindgen_ty_1>() - 32usize];
    ["Alignment of lyd_node_opaq__bindgen_ty_1"]
        [::std::mem::align_of::<lyd_node_opaq__bindgen_ty_1>() - 4usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lyd_node_opaq"][::std::mem::size_of::<lyd_node_opaq>() - 72usize];
    ["Alignment of lyd_node_opaq"]
        [::std::mem::align_of::<lyd_node_opaq>() - 4usize];
    ["Offset of field: lyd_node_opaq::child"]
        [::std::mem::offset_of!(lyd_node_opaq, child) - 32usize];
    ["Offset of field: lyd_node_opaq::name"]
        [::std::mem::offset_of!(lyd_node_opaq, name) - 36usize];
    ["Offset of field: lyd_node_opaq::value"]
        [::std::mem::offset_of!(lyd_node_opaq, value) - 48usize];
    ["Offset of field: lyd_node_opaq::hints"]
        [::std::mem::offset_of!(lyd_node_opaq, hints) - 52usize];
    ["Offset of field: lyd_node_opaq::format"]
        [::std::mem::offset_of!(lyd_node_opaq, format) - 56usize];
    ["Offset of field: lyd_node_opaq::val_prefix_data"]
        [::std::mem::offset_of!(lyd_node_opaq, val_prefix_data) - 60usize];
    ["Offset of field: lyd_node_opaq::attr"]
        [::std::mem::offset_of!(lyd_node_opaq, attr) - 64usize];
    ["Offset of field: lyd_node_opaq::ctx"]
        [::std::mem::offset_of!(lyd_node_opaq, ctx) - 68usize];
};
...
const _: () = {
    ["Size of lyd_leafref_links_rec"]
        [::std::mem::size_of::<lyd_leafref_links_rec>() - 12usize];
    ["Alignment of lyd_leafref_links_rec"]
        [::std::mem::align_of::<lyd_leafref_links_rec>() - 4usize];
    ...
    ["Offset of field: lyd_leafref_links_rec::leafref_nodes"]
        [::std::mem::offset_of!(lyd_leafref_links_rec, leafref_nodes) - 4usize];
    ["Offset of field: lyd_leafref_links_rec::target_nodes"]
        [::std::mem::offset_of!(lyd_leafref_links_rec, target_nodes) - 8usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lysp_stmt"][::std::mem::size_of::<lysp_stmt>() - 32usize];
    ["Alignment of lysp_stmt"][::std::mem::align_of::<lysp_stmt>() - 4usize];
    ["Offset of field: lysp_stmt::stmt"]
        [::std::mem::offset_of!(lysp_stmt, stmt) - 0usize];
    ["Offset of field: lysp_stmt::arg"]
        [::std::mem::offset_of!(lysp_stmt, arg) - 4usize];
    ["Offset of field: lysp_stmt::format"]
        [::std::mem::offset_of!(lysp_stmt, format) - 8usize];
    ["Offset of field: lysp_stmt::prefix_data"]
        [::std::mem::offset_of!(lysp_stmt, prefix_data) - 12usize];
    ["Offset of field: lysp_stmt::next"]
        [::std::mem::offset_of!(lysp_stmt, next) - 16usize];
    ["Offset of field: lysp_stmt::child"]
        [::std::mem::offset_of!(lysp_stmt, child) - 20usize];
    ["Offset of field: lysp_stmt::flags"]
        [::std::mem::offset_of!(lysp_stmt, flags) - 24usize];
    ["Offset of field: lysp_stmt::kw"]
        [::std::mem::offset_of!(lysp_stmt, kw) - 28usize];
};
...
const _: () = {
    ["Size of lysp_ext_substmt"]
        [::std::mem::size_of::<lysp_ext_substmt>() - 8usize];
    ["Alignment of lysp_ext_substmt"]
        [::std::mem::align_of::<lysp_ext_substmt>() - 4usize];
    ...
    ["Offset of field: lysp_ext_substmt::storage_p"]
        [::std::mem::offset_of!(lysp_ext_substmt, storage_p) - 4usize];
};
...
const _: () = {
    ["Size of lysp_ext_instance"]
        [::std::mem::size_of::<lysp_ext_instance>() - 64usize];
    ...
    ["Offset of field: lysp_ext_instance::argument"]
        [::std::mem::offset_of!(lysp_ext_instance, argument) - 4usize];
    ["Offset of field: lysp_ext_instance::format"]
        [::std::mem::offset_of!(lysp_ext_instance, format) - 8usize];
    ["Offset of field: lysp_ext_instance::prefix_data"]
        [::std::mem::offset_of!(lysp_ext_instance, prefix_data) - 12usize];
    ["Offset of field: lysp_ext_instance::plugin_ref"]
        [::std::mem::offset_of!(lysp_ext_instance, plugin_ref) - 16usize];
    ["Offset of field: lysp_ext_instance::parent"]
        [::std::mem::offset_of!(lysp_ext_instance, parent) - 20usize];
    ["Offset of field: lysp_ext_instance::parent_stmt"]
        [::std::mem::offset_of!(lysp_ext_instance, parent_stmt) - 24usize];
    ["Offset of field: lysp_ext_instance::parent_stmt_index"][::std::mem::offset_of!(
        lysp_ext_instance,
        parent_stmt_index
    ) - 32usize];
    ["Offset of field: lysp_ext_instance::flags"]
        [::std::mem::offset_of!(lysp_ext_instance, flags) - 40usize];
    ["Offset of field: lysp_ext_instance::substmts"]
        [::std::mem::offset_of!(lysp_ext_instance, substmts) - 44usize];
    ["Offset of field: lysp_ext_instance::parsed"]
        [::std::mem::offset_of!(lysp_ext_instance, parsed) - 48usize];
    ["Offset of field: lysp_ext_instance::child"]
        [::std::mem::offset_of!(lysp_ext_instance, child) - 52usize];
    ["Offset of field: lysp_ext_instance::exts"]
        [::std::mem::offset_of!(lysp_ext_instance, exts) - 56usize];
};
...
const _: () = {
    ["Size of lysc_ext_substmt"]
        [::std::mem::size_of::<lysc_ext_substmt>() - 8usize];
    ["Alignment of lysc_ext_substmt"]
        [::std::mem::align_of::<lysc_ext_substmt>() - 4usize];
    ...
    ["Offset of field: lysc_ext_substmt::storage_p"]
        [::std::mem::offset_of!(lysc_ext_substmt, storage_p) - 4usize];
};
...
const _: () = {
    ["Size of lysc_ext_instance"]
        [::std::mem::size_of::<lysc_ext_instance>() - 40usize];
    ...
    ["Offset of field: lysc_ext_instance::argument"]
        [::std::mem::offset_of!(lysc_ext_instance, argument) - 4usize];
    ["Offset of field: lysc_ext_instance::module"]
        [::std::mem::offset_of!(lysc_ext_instance, module) - 8usize];
    ["Offset of field: lysc_ext_instance::exts"]
        [::std::mem::offset_of!(lysc_ext_instance, exts) - 12usize];
    ["Offset of field: lysc_ext_instance::parent"]
        [::std::mem::offset_of!(lysc_ext_instance, parent) - 16usize];
    ["Offset of field: lysc_ext_instance::parent_stmt"]
        [::std::mem::offset_of!(lysc_ext_instance, parent_stmt) - 20usize];
    ["Offset of field: lysc_ext_instance::parent_stmt_index"][::std::mem::offset_of!(
        lysc_ext_instance,
        parent_stmt_index
    ) - 24usize];
    ["Offset of field: lysc_ext_instance::substmts"]
        [::std::mem::offset_of!(lysc_ext_instance, substmts) - 32usize];
    ["Offset of field: lysc_ext_instance::compiled"]
        [::std::mem::offset_of!(lysc_ext_instance, compiled) - 36usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lyplg_ext"][::std::mem::size_of::<lyplg_ext>() - 48usize];
    ["Alignment of lyplg_ext"][::std::mem::align_of::<lyplg_ext>() - 4usize];
    ["Offset of field: lyplg_ext::id"]
        [::std::mem::offset_of!(lyplg_ext, id) - 0usize];
    ["Offset of field: lyplg_ext::parse"]
        [::std::mem::offset_of!(lyplg_ext, parse) - 4usize];
    ["Offset of field: lyplg_ext::compile"]
        [::std::mem::offset_of!(lyplg_ext, compile) - 8usize];
    ["Offset of field: lyplg_ext::printer_info"]
        [::std::mem::offset_of!(lyplg_ext, printer_info) - 12usize];
    ["Offset of field: lyplg_ext::node_xpath"]
        [::std::mem::offset_of!(lyplg_ext, node_xpath) - 16usize];
    ["Offset of field: lyplg_ext::snode_xpath"]
        [::std::mem::offset_of!(lyplg_ext, snode_xpath) - 20usize];
    ["Offset of field: lyplg_ext::snode"]
        [::std::mem::offset_of!(lyplg_ext, snode) - 24usize];
    ["Offset of field: lyplg_ext::validate"]
        [::std::mem::offset_of!(lyplg_ext, validate) - 28usize];
    ["Offset of field: lyplg_ext::pfree"]
        [::std::mem::offset_of!(lyplg_ext, pfree) - 32usize];
    ["Offset of field: lyplg_ext::cfree"]
        [::std::mem::offset_of!(lyplg_ext, cfree) - 36usize];
    ["Offset of field: lyplg_ext::compiled_size"]
        [::std::mem::offset_of!(lyplg_ext, compiled_size) - 40usize];
    ["Offset of field: lyplg_ext::compiled_print"]
        [::std::mem::offset_of!(lyplg_ext, compiled_print) - 44usize];
};
...
const _: () = {
    ["Size of lyplg_ext_record"]
        [::std::mem::size_of::<lyplg_ext_record>() - 60usize];
    ["Alignment of lyplg_ext_record"]
        [::std::mem::align_of::<lyplg_ext_record>() - 4usize];
    ...
    ["Offset of field: lyplg_ext_record::revision"]
        [::std::mem::offset_of!(lyplg_ext_record, revision) - 4usize];
    ["Offset of field: lyplg_ext_record::name"]
        [::std::mem::offset_of!(lyplg_ext_record, name) - 8usize];
    ["Offset of field: lyplg_ext_record::plugin"]
        [::std::mem::offset_of!(lyplg_ext_record, plugin) - 12usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of lyd_meta"][::std::mem::size_of::<lyd_meta>() - 48usize];
    ...
    ["Offset of field: lyd_meta::next"]
        [::std::mem::offset_of!(lyd_meta, next) - 4usize];
    ["Offset of field: lyd_meta::annotation"]
        [::std::mem::offset_of!(lyd_meta, annotation) - 8usize];
    ["Offset of field: lyd_meta::name"]
        [::std::mem::offset_of!(lyd_meta, name) - 12usize];
    ["Offset of field: lyd_meta::value"]
        [::std::mem::offset_of!(lyd_meta, value) - 16usize];
};
...
const _: () = {
    ["Size of ly_set__bindgen_ty_1"]
        [::std::mem::size_of::<ly_set__bindgen_ty_1>() - 4usize];
    ["Alignment of ly_set__bindgen_ty_1"]
        [::std::mem::align_of::<ly_set__bindgen_ty_1>() - 4usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ly_set"][::std::mem::size_of::<ly_set>() - 12usize];
    ["Alignment of ly_set"][::std::mem::align_of::<ly_set>() - 4usize];
